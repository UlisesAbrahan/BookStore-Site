            ...
            <div class="row">
                <div class=" cuadricula col-12 col-md-6">
                    ...
                    <ul class=" color1 ">
                        ...
                        <h3 class="Subtitulo2 alinear p30 ">
                            <img class="formImg" src="assets/img/Iconos/mail.svg" width="30px" alt="">
                            Email:<span> LibreríaRamírez@gmail.com</span>
                        </h3>
                    </ul>
                    <span class="editSpan2">SA Ramírez Librería</span>
                </div>
                
                <div class="cuadricula marginFor1 formEdit fondoNegro col-12 col-md-6">
                ...
                <form action="<?=base_url('/guardarConsulta')?>" method="POST">
                        ...
                        <div class="form-group row justify-content-center ">
                            ...
                            <div class=" ">
                            <input id="nombre" value="<?= session('nombre'); ?>" class="form-control" type="text" name="nombre">
                            </div>
                        </div>
                        <div class="form-group row justify-content-center ">
                            <label for="apellido" class="editForm">Ingrese su apellido</label>
                            <div class=" ">
                            <input id="apellido" value="<?= session('apellido'); ?>" class="form-control" type="text" name="apellido">
                            </div>
                        </div>
                    ...
                    <div class="form-group row justify-content-center ">
                            ...
                            <div class="">
                            <input id="email" value="<?= session('email'); ?>" class="form-control" type="text" name="email">
                            </div>
                        </div>  
